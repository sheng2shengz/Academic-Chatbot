    ...
    <div class="container">
        ...
        <div class="text-center" style="font-size: initial">
            <div class="row">
                <div class="col-md-2 mb-3">
                    ...
                    <asp:DropDownList ID="Title_DropDownList" CssClass="form-control" runat="server">
                        ...
                        <asp:ListItem Value="Mr" Selected>Mr</asp:ListItem>
                ...
                <div class="col-md-5 mb-3">
                    ...
                    <asp:TextBox ID="FirstName_TextBox" CssClass="form-control" Text="ipsum" TextMode="SingleLine" runat="server"></asp:TextBox>
                ...
                <div class="col-md-5 mb-3">
                    ...
                    <asp:TextBox ID="LastName_TextBox" CssClass="form-control" Text="dolor" TextMode="SingleLine" runat="server"></asp:TextBox>
            ...
            <div class="mb-3">
                ...
                <asp:TextBox ID="Email_TextBox" Text="asdfasba@gmail.com" CssClass="form-control" runat="server"></asp:TextBox>
            ...
            <div class="form-row mb-3">
                <div class="col-md-6">
                    ...
                    <asp:TextBox ID="Password_TextBox" Text="abc123" CssClass="form-control" TextMode="Password" runat="server"></asp:TextBox>
                ...
                <div class="col-md-6">
                    ...
                    <asp:TextBox ID="ConfirmPassword_TextBox" Text="abc123" CssClass="form-control" TextMode="Password" runat="server"></asp:TextBox>
            ...
            <div class="mb-3">
                ...
                <asp:DropDownList ID="Role_DropDownList" CssClass="form-control" runat="server">
                    ...
                    <asp:ListItem Value="1" Selected>Admin</asp:ListItem>
            ...
            <br />
            <asp:Button ID="Submit_Button" CssClass="col-4 btn btn-primary btn-lg" Text="Update" runat="server" />
        </div>
    </div>
